...
pub fn find_contains(/* Pick and justify your parameters */) -> () /* Pick and justify your return type */
{
    unimplemented!();
}
...
///   [==        ]
pub fn fill_progress_bar(/* Pick and justify your parameters */) -> () /* Pick and justify your return type */
{
    unimplemented!();
}
